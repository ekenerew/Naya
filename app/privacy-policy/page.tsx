      ...
      <section className="relative bg-obsidian-900 overflow-hidden py-20">
        ...
        <div className="page-container relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-white/30 text-sm max-w-xl">This Privacy Policy explains how Naya Real Estate Technologies Ltd collects, uses, stores, and protects your personal data in compliance with the Nigeria Data Protection Act 2023.</p>
          </div>
        </div>
      </section>
        ...
        <div className="page-container">
          <div className="max-w-3xl mx-auto card p-8 space-y-8">
            {[
              ...
              { title: '5. Your Rights', body: 'Under the NDPA 2023 you have the right to access, correct, delete, restrict, and port your data. You may also object to processing. Contact privacy@naya.ng to exercise any right. You may also complain to the Nigeria Data Protection Commission.' },
              ...
              { title: '7. Data Security', body: 'All data is encrypted in transit (TLS 1.3) and at rest (AES-256). We maintain strict access controls and will notify affected users within 72 hours of any confirmed data breach.' },
              { title: '8. Cookies', body: 'We use essential, analytics, and preference cookies to operate and improve the platform. Marketing cookies are only used with your consent.' },
              { title: '9. Changes to This Policy', body: 'We will notify you by email at least 14 days before any material changes take effect. Continued use of the platform constitutes acceptance.' },
              { title: '10. Contact', body: 'Naya Real Estate Technologies Ltd, 23 Aba Road, GRA Phase 2, Port Harcourt, Rivers State. Email: privacy@naya.ng | Phone: +234 816 811 7004' },
            ].map((s, i) => (
              <div key={i}>
