...
export const neighborhoods: Neighborhood[] = [
  ...
  },
  {
    ...
    nearbySchools: ['Hillcrest School', 'Trans Amadi Schools'],
  ...
  },
  {
    ...
    description: 'A rapidly developing suburb popular with young professionals and middle-class families. Rumuola offers modern housing at accessible price points with good infrastructure and proximity to PH Airport.',
  ...
  },
  {
    ...
    description: 'One of Port Harcourt\'s most desirable mid-market neighbourhoods. Woji has seen explosive growth with gated estates and luxury apartment complexes attracting senior executives and diaspora returnees.',
  ...
  {
    id: 'n7', slug: 'gra-phase-1', name: 'GRA Phase 1', lga: 'Port Harcourt',
    description: 'The oldest and most established GRA zone in Port Harcourt. GRA Phase 1 features wide colonial-era boulevards, mature trees, and a mix of government quarters and private residences. Extremely low turnover of properties.',
    character: 'Old money · Government quarters · Established',
    safetyScore: 90, infrastructureScore: 85, schoolScore: 87, floodRiskScore: 80,
    avgRent1br: 1600000, avgRent3br: 4200000, avgBuyPrice: 165000000,
    trend: 'stable', trendPct: 4.1,
    heroGradient: 'from-stone-900 via-stone-800 to-slate-900',
    emoji: '🏰', highlights: ['Colonial boulevards', 'Government quarters', 'Mature trees', 'Very secure'],
    nearbySchools: ['Corona School PH', 'St John\'s College'],
    nearbyHospitals: ['Braithwaite Memorial Specialist Hospital'],
    nearbyLandmarks: ['Government House', 'Isaac Boro Park', 'PH Club'],
    propertyCount: 112
  },
  {
    id: 'n8', slug: 'd-line', name: 'D-Line', lga: 'Port Harcourt',
    description: 'D-Line is one of Port Harcourt\'s most densely populated neighbourhoods, located close to the city centre. Popular with traders, civil servants, and lower-income households. Very high demand for rooms and self-contained apartments.',
    character: 'Urban · High density · Commercial activity',
    safetyScore: 62, infrastructureScore: 65, schoolScore: 70, floodRiskScore: 48,
    avgRent1br: 350000, avgRent3br: 800000, avgBuyPrice: 28000000,
    trend: 'stable', trendPct: 5.2,
    heroGradient: 'from-orange-900 via-amber-800 to-yellow-900',
    emoji: '🏙', highlights: ['City centre access', 'High footfall', 'Affordable', 'Commercial activity'],
    nearbySchools: ['Community Secondary School', 'St Patrick\'s School'],
    nearbyHospitals: ['PH General Hospital', 'University Teaching Hospital'],
    nearbyLandmarks: ['Mile 1 Market', 'City Centre', 'PH Main Market'],
    propertyCount: 534
  },
  {
    id: 'n9', slug: 'diobu', name: 'Diobu (Mile 1–3)', lga: 'Port Harcourt',
    description: 'Diobu encompasses the Mile 1, Mile 2, and Mile 3 areas — the trading and commercial heart of Port Harcourt. One of the most densely populated areas in Rivers State with extremely high commercial property demand.',
    character: 'Commerce · Trading · High density · Affordable',
    safetyScore: 58, infrastructureScore: 62, schoolScore: 68, floodRiskScore: 42,
    avgRent1br: 280000, avgRent3br: 650000, avgBuyPrice: 22000000,
    trend: 'stable', trendPct: 3.8,
    heroGradient: 'from-red-900 via-rose-800 to-orange-900',
    emoji: '🛒', highlights: ['Mile 1 Market hub', 'Affordable housing', 'Transport links', 'Traders paradise'],
    nearbySchools: ['Mile 1 Community School', 'Diobu Secondary School'],
    nearbyHospitals: ['BMH Hospital', 'Diobu Clinic'],
    nearbyLandmarks: ['Mile 1 Market', 'Mile 3 Market', 'Garrison Junction'],
    propertyCount: 687
  },
  {
    id: 'n10', slug: 'borokiri', name: 'Borokiri', lga: 'Port Harcourt',
    description: 'Borokiri is a creekside neighbourhood in old Port Harcourt, known for its fishing community, traditional markets, and proximity to the waterfront. Increasingly attracting urban regeneration interest.',
    character: 'Waterfront · Traditional · Fishing community',
    safetyScore: 60, infrastructureScore: 58, schoolScore: 62, floodRiskScore: 35,
    avgRent1br: 220000, avgRent3br: 520000, avgBuyPrice: 18000000,
    trend: 'stable', trendPct: 2.5,
    heroGradient: 'from-blue-900 via-cyan-800 to-teal-900',
    emoji: '🌊', highlights: ['Waterfront access', 'Traditional market', 'Fishing community', 'Affordable'],
    nearbySchools: ['Borokiri Secondary School', 'Community Primary School'],
    nearbyHospitals: ['Borokiri Clinic', 'PH General Hospital'],
    nearbyLandmarks: ['Borokiri Waterfront', 'PH Creekside', 'Old Township Market'],
    propertyCount: 178
  },
  {
    id: 'n11', slug: 'rumuigbo', name: 'Rumuigbo', lga: 'Obio-Akpor',
    description: 'Rumuigbo is a fast-growing residential suburb in Obio-Akpor LGA. Popular with young families and first-time buyers due to its proximity to schools, markets, and the PH-Aba expressway. New housing estates are transforming the area.',
    character: 'Residential · Growing · Family-friendly',
    safetyScore: 70, infrastructureScore: 71, schoolScore: 76, floodRiskScore: 60,
    avgRent1br: 480000, avgRent3br: 1100000, avgBuyPrice: 42000000,
    trend: 'up', trendPct: 11.4,
    heroGradient: 'from-green-900 via-emerald-800 to-teal-900',
    emoji: '🌿', highlights: ['New estates', 'Schools nearby', 'PH-Aba access', 'Affordable'],
    nearbySchools: ['Rumuigbo Secondary School', 'Excel Academy'],
    nearbyHospitals: ['Rumuigbo Clinic', 'Specialist Hospital Rumuola'],
    nearbyLandmarks: ['Rumuigbo Junction', 'Timber Market', 'PH-Aba Expressway'],
    propertyCount: 321
  },
  {
    id: 'n12', slug: 'rumuokoro', name: 'Rumuokoro', lga: 'Obio-Akpor',
    description: 'Rumuokoro is a busy commercial and residential hub at the intersection of the Eastern Bypass and PH-Aba road. Its strategic location makes it a prime area for commercial property and transit-oriented housing.',
    character: 'Transit hub · Commercial · Mixed-use',
    safetyScore: 65, infrastructureScore: 68, schoolScore: 67, floodRiskScore: 58,
    avgRent1br: 420000, avgRent3br: 980000, avgBuyPrice: 36000000,
    trend: 'up', trendPct: 9.8,
    heroGradient: 'from-indigo-900 via-blue-800 to-violet-900',
    emoji: '🔄', highlights: ['Transport hub', 'Eastern Bypass access', 'Commercial strip', 'Growing area'],
    nearbySchools: ['Rumuokoro Secondary', 'Faith Academy'],
    nearbyHospitals: ['Eastern Bypass Clinic', 'Rumuokoro Health Centre'],
    nearbyLandmarks: ['Rumuokoro Junction', 'Eastern Bypass', 'PH-Aba Expressway'],
    propertyCount: 289
  },
  {
    id: 'n13', slug: 'choba', name: 'Choba', lga: 'Obio-Akpor',
    description: 'Choba is a university town area anchored by the University of Port Harcourt campus. High demand for student accommodation, staff quarters, and affordable apartments. A dynamic, youthful neighbourhood.',
    character: 'University town · Student housing · Youthful',
    safetyScore: 68, infrastructureScore: 66, schoolScore: 95, floodRiskScore: 62,
    avgRent1br: 380000, avgRent3br: 880000, avgBuyPrice: 32000000,
    trend: 'up', trendPct: 13.2,
    heroGradient: 'from-purple-900 via-violet-800 to-indigo-900',
    emoji: '🎓', highlights: ['UniPort campus', 'Student demand', 'Affordable rents', 'Young community'],
    nearbySchools: ['University of Port Harcourt', 'UniPort Secondary School'],
    nearbyHospitals: ['UniPort Teaching Hospital', 'Choba Health Centre'],
    nearbyLandmarks: ['UniPort Main Gate', 'Faculty of Engineering', 'Choba Park'],
    propertyCount: 412
  },
  {
    id: 'n14', slug: 'rumueme', name: 'Rumueme', lga: 'Obio-Akpor',
    description: 'Rumueme is an established residential community between Rumuola and the airport. Quiet, family-oriented streets with a mix of bungalows and modern duplexes. Increasingly popular with airport workers and aviation professionals.',
    character: 'Quiet · Family homes · Airport proximity',
    safetyScore: 73, infrastructureScore: 72, schoolScore: 74, floodRiskScore: 63,
    avgRent1br: 520000, avgRent3br: 1200000, avgBuyPrice: 46000000,
    trend: 'up', trendPct: 10.6,
    heroGradient: 'from-teal-900 via-cyan-800 to-blue-900',
    emoji: '✈️', highlights: ['Airport proximity', 'Family estates', 'Quiet streets', 'Aviation workforce'],
    nearbySchools: ['Rumueme Secondary School', 'Airport Road Schools'],
    nearbyHospitals: ['Rumueme Clinic', 'Airport Health Post'],
    nearbyLandmarks: ['PH International Airport (3km)', 'Airport Road', 'Rumueme Junction'],
    propertyCount: 267
  },
  {
    id: 'n15', slug: 'peter-odili-road', name: 'Peter Odili Road', lga: 'Port Harcourt',
    description: 'Peter Odili Road is one of Port Harcourt\'s most prestigious addresses, connecting GRA Phase 2 to Woji. Lined with luxury homes, corporate headquarters, and upscale hotels. One of the highest land values in the city.',
    character: 'Prestige corridor · Corporate · High value',
    safetyScore: 89, infrastructureScore: 86, schoolScore: 83, floodRiskScore: 75,
    avgRent1br: 2000000, avgRent3br: 5500000, avgBuyPrice: 210000000,
    trend: 'up', trendPct: 14.2,
    heroGradient: 'from-gold-900 via-amber-800 to-yellow-900',
    emoji: '🛣', highlights: ['Premier address', 'Corporate HQs', 'Luxury hotels', 'High land value'],
    nearbySchools: ['Graceland Int\'l School', 'Capital Science Academy'],
    nearbyHospitals: ['De-integrated Hospital', 'Medbury Hospital'],
    nearbyLandmarks: ['Trans Amadi Junction', 'PH Towers', 'Polo Club'],
    propertyCount: 145
  },
  {
    id: 'n16', slug: 'obio-akpor', name: 'Obio-Akpor (General)', lga: 'Obio-Akpor',
    description: 'Obio-Akpor LGA is the fastest-growing local government in Rivers State. Encompassing neighbourhoods like Rumuola, Woji, Rumuigbo and Choba, it is the primary growth engine for new residential development in Greater Port Harcourt.',
    character: 'High growth · New developments · Suburban expansion',
    safetyScore: 74, infrastructureScore: 73, schoolScore: 77, floodRiskScore: 62,
    avgRent1br: 700000, avgRent3br: 1600000, avgBuyPrice: 68000000,
    trend: 'up', trendPct: 17.1,
    heroGradient: 'from-lime-900 via-green-800 to-emerald-900',
    emoji: '🌱', highlights: ['Fastest growing LGA', 'New estates', 'Value for money', 'Great infrastructure'],
    nearbySchools: ['Multiple international schools', 'State secondary schools'],
    nearbyHospitals: ['Multiple private clinics', 'UPTH Satellite Clinics'],
    nearbyLandmarks: ['Eastern Bypass', 'PH-Aba Expressway', 'Rumuola Junction'],
    propertyCount: 876
  },
  {
    id: 'n17', slug: 'stadium-road', name: 'Stadium Road', lga: 'Port Harcourt',
    description: 'Stadium Road is a vibrant mid-market neighbourhood named after the Sharks Stadium. A mix of residential and commercial properties with strong rental demand from sports professionals, young executives, and civil servants.',
    character: 'Mid-market · Sports hub · Active community',
    safetyScore: 71, infrastructureScore: 73, schoolScore: 72, floodRiskScore: 62,
    avgRent1br: 650000, avgRent3br: 1500000, avgBuyPrice: 52000000,
    trend: 'up', trendPct: 8.9,
    heroGradient: 'from-green-900 via-lime-800 to-emerald-900',
    emoji: '🏟', highlights: ['Sharks Stadium', 'Sports facilities', 'Mixed-use', 'Good roads'],
    nearbySchools: ['Stadium Road Schools', 'Sports Academy PH'],
    nearbyHospitals: ['PH Sports Medicine Centre', 'Stadium Clinic'],
    nearbyLandmarks: ['Sharks FC Stadium', 'Eagle Island', 'Rumuola Road junction'],
    propertyCount: 198
  },
  {
    id: 'n18', slug: 'oyigbo', name: 'Oyigbo', lga: 'Oyigbo',
    description: 'Oyigbo is a growing town in Rivers State between Port Harcourt and Abia State. A strategic trading and transit corridor with strong commercial activity along the PH-Aba expressway. Affordable housing with high growth potential.',
    character: 'Trade corridor · Affordable · Growth potential',
    safetyScore: 64, infrastructureScore: 63, schoolScore: 65, floodRiskScore: 55,
    avgRent1br: 240000, avgRent3br: 580000, avgBuyPrice: 18000000,
    trend: 'up', trendPct: 7.3,
    heroGradient: 'from-yellow-900 via-amber-800 to-orange-900',
    emoji: '🚉', highlights: ['PH-Aba corridor', 'Affordable land', 'Trade town', 'Railway proximity'],
    nearbySchools: ['Oyigbo Secondary School', 'Community Primary Schools'],
    nearbyHospitals: ['Oyigbo General Hospital', 'Railway Compound Clinic'],
    nearbyLandmarks: ['PH-Aba Highway', 'Oyigbo Railway Station', 'Afam Power Plant'],
    propertyCount: 156
  },
  {
    id: 'n19', slug: 'okrika', name: 'Okrika', lga: 'Okrika',
    description: 'Okrika is an island community and LGA in Rivers State. Known for its vibrant fishing culture and proximity to the ocean. Strong demand from oil & gas workers due to proximity to offshore platforms and SPDC facilities.',
    character: 'Island community · Fishing · Oil & Gas offshore',
    safetyScore: 66, infrastructureScore: 60, schoolScore: 63, floodRiskScore: 40,
    avgRent1br: 320000, avgRent3br: 780000, avgBuyPrice: 28000000,
    trend: 'stable', trendPct: 4.1,
    heroGradient: 'from-blue-900 via-indigo-800 to-blue-900',
    emoji: '🛥', highlights: ['Island location', 'Offshore access', 'Fishing industry', 'Oil platform workers'],
    nearbySchools: ['Okrika Grammar School', 'Community Schools'],
    nearbyHospitals: ['Okrika General Hospital', 'SPDC Medical Centre'],
    nearbyLandmarks: ['Okrika Creek', 'SPDC Flow Station', 'Okrika Jetty'],
    propertyCount: 134
  },
  {
    id: 'n20', slug: 'bonny-island', name: 'Bonny Island', lga: 'Bonny',
    description: 'Bonny Island is one of Nigeria\'s most strategically important oil & gas locations. Home to the NLNG liquefied natural gas plant, it has extremely high demand for premium housing from international oil workers, engineers, and NLNG staff.',
    character: 'NLNG hub · Expat housing · Premium demand',
    safetyScore: 78, infrastructureScore: 74, schoolScore: 70, floodRiskScore: 38,
    avgRent1br: 1200000, avgRent3br: 3200000, avgBuyPrice: 95000000,
    trend: 'up', trendPct: 22.4,
    heroGradient: 'from-teal-900 via-cyan-800 to-blue-900',
    emoji: '🏝', highlights: ['NLNG plant', 'Highest expat demand', 'Premium rents', 'Island living'],
    nearbySchools: ['NLNG School', 'Bonny National Grammar School'],
    nearbyHospitals: ['NLNG Hospital', 'Bonny Island Clinic'],
    nearbyLandmarks: ['NLNG LNG Terminal', 'Bonny Kingdom Palace', 'Bonny River'],
    propertyCount: 167
  },
  {
    id: 'n21', slug: 'alakahia', name: 'Alakahia', lga: 'Obio-Akpor',
    description: 'Alakahia is an emerging residential suburb near the University of Port Harcourt. Its proximity to UniPort and affordable land prices make it popular with academics, students, and first-time buyers.',
    character: 'University adjacent · Affordable · Emerging',
    safetyScore: 67, infrastructureScore: 64, schoolScore: 88, floodRiskScore: 58,
    avgRent1br: 350000, avgRent3br: 820000, avgBuyPrice: 28000000,
    trend: 'up', trendPct: 12.8,
    heroGradient: 'from-violet-900 via-purple-800 to-fuchsia-900',
    emoji: '📚', highlights: ['UniPort adjacent', 'Student housing', 'Affordable plots', 'Academic community'],
    nearbySchools: ['University of Port Harcourt', 'Alakahia Community School'],
    nearbyHospitals: ['UniPort Teaching Hospital', 'Alakahia Clinic'],
    nearbyLandmarks: ['UniPort Campus', 'Choba Road', 'Rumuosi Community'],
    propertyCount: 234
  },
  {
    id: 'n22', slug: 'rumuibekwe', name: 'Rumuibekwe', lga: 'Obio-Akpor',
    description: 'Rumuibekwe is a quiet, well-established residential neighbourhood in Obio-Akpor. Known for orderly streets, good community governance, and a strong mix of civil servant and professional residents.',
    character: 'Quiet residential · Civil servants · Orderly',
    safetyScore: 75, infrastructureScore: 70, schoolScore: 75, floodRiskScore: 64,
    avgRent1br: 460000, avgRent3br: 1050000, avgBuyPrice: 40000000,
    trend: 'up', trendPct: 9.1,
    heroGradient: 'from-sky-900 via-blue-800 to-indigo-900',
    emoji: '🏡', highlights: ['Quiet streets', 'Civil servants', 'Family community', 'Good governance'],
    nearbySchools: ['Rumuibekwe Secondary School', 'Faith Comprehensive College'],
    nearbyHospitals: ['Rumuibekwe Clinic', 'Specialist Hospital Rumuola'],
    nearbyLandmarks: ['Rumuibekwe Layout', 'Rumuola Road', 'Obio-Akpor Secretariat'],
    propertyCount: 198
  },
]
...
export const blogPosts: BlogPost[] = [
  { id: 'b1', slug: 'best-areas-to-live-in-port-harcourt-2026', title: 'The 6 Best Areas to Live in Port Harcourt in 2026', excerpt: 'From the prestigious GRA to the rapidly developing Woji corridor — a comprehensive guide to PH\'s top neighbourhoods for every budget and lifestyle.', category: 'Area Guide', readTime: 8, publishedAt: '2026-03-05', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '📍', featured: true },
  { id: 'b2', slug: 'expat-housing-guide-port-harcourt', title: 'The Ultimate Expat Housing Guide — Port Harcourt', excerpt: 'Everything international workers in the oil & gas sector need to know about finding and securing premium accommodation in PH. GRA, Woji, Trans Amadi explained.', category: 'Expat Guide', readTime: 12, publishedAt: '2026-02-28', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '✈️', featured: true },
  { id: 'b3', slug: 'ph-real-estate-market-report-q1-2026', title: 'Port Harcourt Real Estate Market Report — Q1 2026', excerpt: 'Prices up 30% YoY. Woji leading growth at +18.7%. Shortlet demand surges. Full data on rents, sales, and investment outlook for the Garden City.', category: 'Market Report', readTime: 6, publishedAt: '2026-03-01', author: 'Naya Research', authorRole: 'Research Team', emoji: '📊', featured: true },
  { id: 'b4', slug: 'how-to-verify-agent-rsspc-nigeria', title: 'How to Verify Your Agent\'s RSSPC Licence in Nigeria', excerpt: 'Don\'t get scammed. Here\'s the exact step-by-step process to check if your estate agent is genuinely RSSPC certified before paying any fees.', category: 'Legal Guide', readTime: 5, publishedAt: '2026-02-15', author: 'Naya Legal', authorRole: 'Legal Advisor', emoji: '🏛', featured: false },
  { id: 'b5', slug: 'mortgage-guide-nigeria-2026', title: 'Getting a Mortgage in Nigeria: What You Need to Know in 2026', excerpt: 'NHF loans, commercial bank mortgages, and FMBN explained. A practical step-by-step guide for first-time buyers in Port Harcourt and Rivers State.', category: 'Finance', readTime: 10, publishedAt: '2026-02-08', author: 'Naya Finance', authorRole: 'Financial Advisor', emoji: '🏦', featured: false },
  { id: 'b6', slug: 'investment-property-port-harcourt-returns', title: 'Rental Yield vs Capital Growth: Investing in PH Property', excerpt: 'Which neighbourhoods offer the best rental yields? Where is capital appreciation strongest? Data-backed analysis of every major PH area.', category: 'Investment', readTime: 9, publishedAt: '2026-01-22', author: 'Naya Research', authorRole: 'Research Team', emoji: '💰', featured: true },
  { id: 'b7', slug: 'how-to-avoid-property-scams-nigeria', title: 'How to Avoid Property Scams in Nigeria: The Complete Guide', excerpt: 'Fake landlords, double-selling, forged C of O — here are the 12 most common property scams in Nigeria and exactly how to protect yourself.', category: 'Legal Guide', readTime: 11, publishedAt: '2026-03-08', author: 'Naya Legal', authorRole: 'Legal Advisor', emoji: '🛡', featured: true },
  { id: 'b8', slug: 'first-time-buyer-guide-port-harcourt', title: 'First-Time Buyer\'s Complete Guide to Buying Property in PH', excerpt: 'From budget planning to signing the deed — a 10-step walkthrough of buying your first property in Port Harcourt. What to expect, what to avoid, what to demand.', category: 'Buyer Guide', readTime: 15, publishedAt: '2026-03-03', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '🏠', featured: true },
  { id: 'b9', slug: 'understanding-land-titles-nigeria-coo-vs-doa', title: 'C of O vs Deed of Assignment vs Governor\'s Consent: What\'s the Difference?', excerpt: 'The single most important thing to check before buying land or property in Nigeria. A plain-English breakdown of every title type and what they mean for you.', category: 'Legal Guide', readTime: 8, publishedAt: '2026-02-22', author: 'Naya Legal', authorRole: 'Legal Advisor', emoji: '📜', featured: false },
  { id: 'b10', slug: 'gra-phase-2-neighbourhood-guide', title: 'GRA Phase 2 Neighbourhood Guide: Prices, Schools, and What to Expect', excerpt: 'Everything you need to know about Port Harcourt\'s most prestigious address. Current rents, sale prices, security levels, schools, and who lives there.', category: 'Area Guide', readTime: 7, publishedAt: '2026-02-18', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '🏛', featured: false },
  { id: 'b11', slug: 'woji-real-estate-investment-guide', title: 'Why Woji is Port Harcourt\'s Best Investment Neighbourhood Right Now', excerpt: 'Up 18.7% in 12 months. New gated estates. Diaspora returnees flooding in. Here\'s why smart investors are pivoting from GRA to Woji in 2026.', category: 'Investment', readTime: 8, publishedAt: '2026-02-10', author: 'Naya Research', authorRole: 'Research Team', emoji: '📈', featured: false },
  { id: 'b12', slug: 'shortlet-business-guide-nigeria', title: 'How to Run a Profitable Shortlet Business in Port Harcourt', excerpt: 'Yields of 20–35%, 90%+ occupancy during oil season. How to set up, furnish, price, and manage a shortlet apartment in PH. Complete operator guide.', category: 'Investment', readTime: 13, publishedAt: '2026-01-30', author: 'Naya Research', authorRole: 'Research Team', emoji: '🛎', featured: false },
  { id: 'b13', slug: 'tenancy-agreement-guide-nigeria', title: 'Tenancy Agreements in Nigeria: What Every Renter Must Demand', excerpt: 'What must be in your tenancy agreement. What landlords cannot legally do. What to do when a landlord breaches the agreement. Know your rights.', category: 'Legal Guide', readTime: 9, publishedAt: '2026-01-15', author: 'Naya Legal', authorRole: 'Legal Advisor', emoji: '📋', featured: false },
  { id: 'b14', slug: 'bonny-island-property-investment', title: 'Bonny Island: Nigeria\'s Most Overlooked Property Investment?', excerpt: 'NLNG Train 7 is transforming Bonny Island\'s housing market. Prices up 22.4% in 12 months. Is it too late to invest — or are you still early?', category: 'Investment', readTime: 7, publishedAt: '2026-01-08', author: 'Naya Research', authorRole: 'Research Team', emoji: '🏝', featured: false },
  { id: 'b15', slug: 'property-due-diligence-checklist-nigeria', title: 'The 10-Point Property Due Diligence Checklist Every Nigerian Buyer Needs', excerpt: 'Before you sign anything or transfer a single naira — run through this checklist. Covers title, survey, building approval, land use, and more.', category: 'Legal Guide', readTime: 6, publishedAt: '2026-01-20', author: 'Naya Legal', authorRole: 'Legal Advisor', emoji: '✅', featured: false },
  { id: 'b16', slug: 'diaspora-buying-property-nigeria-guide', title: 'Diaspora Guide: Buying Property in Nigeria from Abroad', excerpt: 'Living in the UK, US, or Canada and want to buy property in PH? Here\'s everything — power of attorney, trusted agents, payment, title transfer, and management.', category: 'Buyer Guide', readTime: 14, publishedAt: '2026-01-05', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '🌍', featured: false },
  { id: 'b17', slug: 'property-tax-nigeria-landlord-guide', title: 'Property Tax in Nigeria: What Landlords Must Know in 2026', excerpt: 'Capital gains tax, stamp duty, ground rent, and land use charge — what you owe, when you pay, and how to minimise your tax liability legally.', category: 'Finance', readTime: 8, publishedAt: '2025-12-18', author: 'Naya Finance', authorRole: 'Financial Advisor', emoji: '🧾', featured: false },
  { id: 'b18', slug: 'rumuola-area-guide-2026', title: 'Rumuola Area Guide: Port Harcourt\'s Best Value Neighbourhood', excerpt: 'Near the airport, strong schools, fast-growing — and still affordable. Rumuola is PH\'s secret weapon for first-time buyers and smart investors in 2026.', category: 'Area Guide', readTime: 6, publishedAt: '2025-12-10', author: 'Naya Editorial', authorRole: 'Editorial Team', emoji: '🌆', featured: false },
]
