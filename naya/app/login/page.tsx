      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          {tab === 'phone' && (
            <div>
              <button
                onClick={() => { setTab('email'); setPhoneStep('number'); setOtp(''); setPhone(''); setError('') }}
              ...
              {phoneStep === 'number' && (
                <form onSubmit={sendOtp} className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-obsidian-400 mt-1.5">Nigerian mobile number. Code sent via SMS.</p>
                  </div>
