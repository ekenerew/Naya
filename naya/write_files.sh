...
# Write terms-of-service directly
mkdir -p app/terms-of-service
cat > app/terms-of-service/page.tsx << 'ENDTERMS'
'use client'
...
# Write privacy-policy directly
mkdir -p app/privacy-policy
cat > app/privacy-policy/page.tsx << 'ENDPRIVACY'
'use client'
...
# Fix logo size
sed -i 's/className="h-10 w-auto/className="h-14 w-auto/g' components/layout/Navbar.tsx
sed -i 's/className="h-12 w-auto/className="h-14 w-auto/g' components/layout/Navbar.tsx
sed -i 's/width={90} height={45}/width={160} height={64}/g' components/layout/Navbar.tsx
sed -i 's/width={140} height={56}/width={160} height={64}/g' components/layout/Navbar.tsx

echo "Files written:"
wc -l app/terms-of-service/page.tsx app/privacy-policy/page.tsx
echo "Logo:"
...
git status
git commit -m "Fix: terms-of-service, privacy-policy pages, bigger logo"
