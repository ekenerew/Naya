...
export const metadata: Metadata = {
  ...
  description: "Find verified properties for rent, sale, and shortlet in Port Harcourt. Virtual tours, RSSPC-verified agents, and AI valuations. Nigeria's premium property marketplace.",
  keywords: ['property', 'Port Harcourt', 'real estate', 'rent', 'buy', 'Nigeria', 'GRA', 'Woji'],
  metadataBase: new URL('https://naya.ng'),
